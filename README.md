...
| [Relay](https://github.com/joshuacris/relay) | AI memory layer that captures the *why* behind merged PRs (Cerebras) and flags conflicting decisions in a Backboard knowledge graph; queryable by devs & AI agents |
